...
$ButtonStatusInView = Template::showButtonStatus($itemsStatus);
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
           @include('admin.templates.x_title',['haha'=>'Bộ lọc'])
            <div class="x_content">
                <div class="row">
                    <div class="col-md-6">
                 {!! $ButtonStatusInView !!}
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            @include('admin.templates.x_title',['haha'=>'Danh sách'])
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
           @include('admin.templates.x_title',['haha'=>'Phân trang1'])
